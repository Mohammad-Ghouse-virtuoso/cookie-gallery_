...
export default function Home() {
  ...
  return (
    <div className="font-inter antialiased">
      ...
      {/* Marketing CTA to Catalogue */}
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-extrabold text-gray-800 mb-4">Explore the full catalogue</h2>
          <p className="text-lg text-gray-600 mb-8">Filter by flavors, tags and discover your next favorite bite.</p>
          <Link
            to="/cookies"
            className="inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-xl shadow-lg transition-all"
          >
            Browse Cookies
          </Link>
        </div>
