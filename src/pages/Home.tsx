...
export default function Home() {
  ...
  return (
    <main className="font-inter antialiased">
      {/* Maintenance Banner */}
      <div className="bg-amber-500 text-amber-950 px-4 py-3 text-center font-medium">
        <span className="inline-flex items-center gap-2">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
          </svg>
          Payment is temporarily unavailable. Please explore our cookie collection — checkout will be back soon!
        </span>
      </div>
